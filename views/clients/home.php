            ...
            <div class="col-md-3">
                <div class="product-box">
                    ...
                    <div class="product-info">
                        <a href="<?= ROOT_URL . '?ctl=detail&id=' . $nike['id'] ?>" style="text-decoration: none !important;">
        ...
        <?php foreach($adidass as $adidas) : ?>
            <div class="col-md-3">
                <div class="product-box">
                    ...
                    <div class="product-info">
                        <a href="<?= ROOT_URL . '?ctl=detail&id=' . $adidas['id'] ?>" style="text-decoration: none !important;">
        ...
        <?php foreach($mlbs as $mlb) : ?>
            <div class="col-md-3">
                <div class="product-box">
                    ...
                    <div class="product-info">
                        <a href="<?= ROOT_URL . '?ctl=detail&id=' . $mlb['id'] ?>" style="text-decoration: none !important;">
